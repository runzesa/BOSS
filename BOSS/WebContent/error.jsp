...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" scroll="no" style="height:100%;">
<table width="1024" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td height="80px" id="pic1" class="logo"></td>
  </tr>
  <tr> 
    <td height="6px" id="pic2"></td>
  </tr>
  <tr> 
    <td id="pic" height="80%;"> <table width="350px" height="250px" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td>
		  <div id="xsnazzy">
...
<div class="xboxcontent">
                <h1>提示信息</h1>
                <p>&nbsp;&nbsp;&nbsp;对不起，您没有执行该操作的权限！<br>
                  &nbsp;&nbsp;&nbsp;<font color="#FF0000"><a href="#" onclick="javascript:history.go(-1)">返回</a></font></p>
</div>
