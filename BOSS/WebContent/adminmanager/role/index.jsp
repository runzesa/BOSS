...
<div class="right_date_top_nav">
      <ul>
      <li class="new"><a href="roleinsertselect.do">添加</a></li>
...
<table  width="100%" cellpadding="0" cellspacing="1" bgcolor="#9dabb6">
	<tr style="background:url(../images/title_bg.gif) repeat-x;font-weight:bold;">
		...
		<td><div align="center"><a href="<%=request.getAttribute("url") %>&order=name&ordertype=<%=request.getAttribute("ordertype") %>">角色名称</a><img src="../images/search.png" style="cursor:hand;vertical-align:middle;margin:0 0 0 5px;" onclick="search('name')" /></div></td>
		...
		<td><div align="center">编辑</div></td>
			...
			<tr bgcolor="#ffffff">
				...
				<td><div align="center"><a href="roleupdateselect.do?updateid=<%=bean.getId() %>">编辑</a></div></td>
			</tr>
			<%
					flag = 0;
					} else {
