...
<script language="JavaScript">
	function sub(){
		...
		XMLHttp.sendReq('post', "developer_login.do?username="+uname+"&password="+pwd+"&rand="+rand+"", null, redata);
	}
	function redata(xmlObj){
		...
		if(check!="true"){
			...
			window.location="developer_main.jsp";
		}
	}
</script>
