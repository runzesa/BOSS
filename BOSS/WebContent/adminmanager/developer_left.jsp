...
<script>
TaskMenu.setStyle("css/taskmenu_d.css"); 
...
window.onload = function(){
	...
	item3 = new TaskMenuItem("标准模块管理","images/taskmenu/67.png","parent.window.frames[2].location.href='module/select.do'");
	...
	item7 = new TaskMenuItem("数据分析","images/taskmenu/53.png","parent.window.frames[2].location.href='dataanalysis/select.do?act=tab'");
	...
	item15 = new TaskMenuItem("特殊模块管理","images/taskmenu/67.png","parent.window.frames[2].location.href='module2/select.do'");
