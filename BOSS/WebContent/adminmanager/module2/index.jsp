...
<table  width="100%" cellpadding="0" cellspacing="1" bgcolor="#9dabb6">
			<tr style="background:url(../images/title_bg.gif) repeat-x;font-weight:bold;">
				...
				<td><div align="center"><a href="<%=request.getAttribute("url") %>&order=name&ordertype=<%=request.getAttribute("ordertype") %>">模块地址</a><img src="../images/search.png" style="cursor:hand;vertical-align:middle;margin:0 0 0 5px;" onclick="search('path')" /></div></td>
			...
			<%
				...
				while (it.hasNext()) {
					ModuleSelectActionBean bean = (ModuleSelectActionBean) it.next();
					if (flag == 1) {
			%>
			<tr bgcolor="#F2F9FD" >
				...
				<td><div align="center"><%=bean.getPath()%></div></td>
