...
function sort(fieldName){
	selectDataLoad1();
	var fields=new Array("name","id_card_no","phone_no","account","role","sex","job_title","hospital","department","society","section","liaisons","point","credit","register_time","email","birthday","college","is_identify","area");
	if(order==null){
		order="true";
