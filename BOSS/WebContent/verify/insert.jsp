...
<div class="right_date_top">
    <div>
		<h1><a href="#" onmousemove="showTip();" onmouseout="closeTip();">医生审核</a></h1>
...
&nbsp;&nbsp;</td>
	...
	<tr>
		<td  class="insert_td_bg"><div align="right">简介：：</div></td>
		<td align="left">&nbsp;&nbsp;
<textarea id="brief" name="brief"  fieldMaxLength="2000"></textarea>
&nbsp;&nbsp;</td>
	</tr>
	<tr>
	...
	<tr>
		<td  class="insert_td_bg"><div align="right">毕业院校：：</div></td>
		<td align="left">&nbsp;&nbsp;<input type="text" id="college"  fieldMaxLength="50"/>&nbsp;&nbsp;</td>
	</tr>
	<tr>
		<td  class="insert_td_bg"><div align="right">所属学会：：</div></td>
		<td align="left">&nbsp;&nbsp;<input type="text" id="society"  fieldMaxLength="100"/>&nbsp;&nbsp;</td>
	</tr>
	<tr>
		<td  class="insert_td_bg"><div align="right">所在医院：：</div></td>
		<td align="left">&nbsp;&nbsp;<select id="hospital" name="hospital">
	</select>
&nbsp;&nbsp;</td>
	</tr>
	<tr>
		<td  class="insert_td_bg"><div align="right">科室：：</div></td>
		<td align="left">&nbsp;&nbsp;<select id="department" name="department">
	</select>
&nbsp;&nbsp;</td>
	</tr>
	<tr>
		<td  class="insert_td_bg"><div align="right">职称：：</div></td>
		<td align="left">&nbsp;&nbsp;<select id="job_title" name="job_title">
	</select>
&nbsp;&nbsp;</td>
	</tr>
	<tr>
		<td  class="insert_td_bg"><div align="right">所属学科：：</div></td>
		<td align="left">&nbsp;&nbsp;<select id="section" name="section">
	</select>
&nbsp;&nbsp;</td>
	</tr>
	<tr>
		<td  class="insert_td_bg"><div align="right">医学联络员：：</div></td>
		<td align="left">&nbsp;&nbsp;<select id="liaisons" name="liaisons">
	</select>
&nbsp;&nbsp;</td>
	</tr>
	<tr>
