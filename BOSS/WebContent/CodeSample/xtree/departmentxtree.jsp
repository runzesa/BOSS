...
<table border="0" width="95%" cellspacing="0" cellpadding="0"
	...
	<tr>
		...
		var tree = new WebFXLoadTree("/部门列表", "xtreedepartment.do?pid=0&formname=<%=request.getParameter("formname")%>&nameinput=<%=request.getParameter("nameinput")%>&idinput=<%=request.getParameter("idinput")%>");
		tree.write();
		</script>
