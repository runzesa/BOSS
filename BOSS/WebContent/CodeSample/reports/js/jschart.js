...
.	  */
	...
	getColumnValue		: function(dataItemValue) {
		...
		if (o.showPercent) {
      var v = o.dataSum == 0 ? 0 : new Number(dataItemValue) * 100 / o.dataSum;
      var percent = "(" + Math.round(v) + "%)"
	...
	appendToLegend		: function(dataItemLabel, dataItemColor, dataItemValue) {
		...
		legendItem.style.borderLeftWidth = "14px";
		...
		legendItem.style.lineHeight = "150%";
