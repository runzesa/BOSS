...
<div>
	<h1><a href="#" onmousemove="showTip();" onmouseout="closeTip();">普通用户管理</a></h1>
	<div id="opendiv">当前位置：普通用户管理</div> 
	...
	<div style="display: block;" class="search_div">
		<div id="select_boxstyle">
			<select name="searchfield" id="searchfield">
				<option value="name">用户名</option><option value="id_card_no">身份证号</option><option value="phone_no">电话</option><option value="account">账号</option><option value="password">密码</option><option value="old_password">曾用密码</option><option value="role">角色</option><option value="sex">性别</option><option value="point">积分</option><option value="credit">学分</option><option value="register_time">注册时间</option><option value="modify_time">修改时间</option><option value="email">email</option><option value="birthday">生日</option><option value="is_identify">认证情况</option><option value="status">状态</option><option value="area">地区</option>
			</select>
		</div>
