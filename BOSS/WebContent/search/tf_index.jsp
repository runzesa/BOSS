...
<div class="right_date_top_nav">
	<ul>
      ...
      %>
		<li class="new"><a href="tf_insertselectnew.do">添加</a></li>
...
<table  width="100%" cellpadding="0" cellspacing="1" bgcolor="#9dabb6">
			<tr style="background:url(../adminmanager/images/title_bg.gif) repeat-x;font-weight:bold;">
				...
				<td><div align="center"><a href="<%=request.getAttribute("url") %>&order=fieldvalue&ordertype=<%=request.getAttribute("ordertype") %>">字段名称</a><img src="../adminmanager/images/search.png" style="cursor:hand;vertical-align:middle;margin:0 0 0 5px;" onclick="search('fieldvalue')" /></div></td>
				<td><div align="center"><a href="<%=request.getAttribute("url") %>&order=fieldtext&ordertype=<%=request.getAttribute("ordertype") %>">显示名称</a><img src="../adminmanager/images/search.png" style="cursor:hand;vertical-align:middle;margin:0 0 0 5px;" onclick="search('fieldtext')" /></div></td>
				<td><div align="center"><a href="<%=request.getAttribute("url") %>&order=oftable&ordertype=<%=request.getAttribute("ordertype") %>">属于</a><img src="../adminmanager/images/search.png" style="cursor:hand;vertical-align:middle;margin:0 0 0 5px;" onclick="search('oftable')" /></div></td>
				<td><div align="center"><a href="<%=request.getAttribute("url") %>&order=fieldtype&ordertype=<%=request.getAttribute("ordertype") %>">字段类型</a><img src="../adminmanager/images/search.png" style="cursor:hand;vertical-align:middle;margin:0 0 0 5px;" onclick="search('fieldtype')" /></div></td>
			...
			<tr bgcolor="#F2F9FD">
				...
				<td><div align="center"><a href="tf_insertselectedit.do?id=<%=bean.getId() %>">编辑</a></div></td>
			</tr>
			<%
						flag = 0;
					} else {
