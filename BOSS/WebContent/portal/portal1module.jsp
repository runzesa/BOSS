...
<table width="100%" height="41" border="0" cellpadding="0"
	...
	<%
	 ...
	 list = module.windowSelectShortCut();
	 for(int i = 0;i<list.size();i++)
	 {
		 ...
		 {			 
			 out.println("var tree"+bean.getId()+"= new WebFXTreeItem('"+ bean.getPortletName() +"','portal1modulewindow.jsp?name="+bean.getPortletName()+"&link="+bean.getPortletLink()+"');"); 
