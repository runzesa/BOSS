...
function get_type(type){
	switch(type){
		case 'id_type':
			return 'string';
		case 'resource_id_type':
			return 'string';
		case 'img_url_type':
			return 'string';
		case 'dest_type_type':
			return 'string';
		case 'reource_param_type':
			return 'string';
		case 'resource_order_type':
			return 'string';
		case 'is_delete_type':
			return 'string';
		case 'show_type_type':
			return 'string';
		case 'resource_name_type':
			return 'string';
		case 'show_position_type':
			return 'string';
		case 'resource_type_type':
			return 'string';
		case 'crreate_time_type':
			return 'string';
		case 'create_user_type':
			return 'string';
		case 'modify_time_type':
			return 'string';
		case 'modify_user_type':
			return 'string';
	}
}
