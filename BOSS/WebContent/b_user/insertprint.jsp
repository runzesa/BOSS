...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#cccccc">
	...
	<tr bgcolor="#FFFFFF">
		<td  class="F" width=20% valign='top' bgcolor='#efefef'>密码：:</td>
		<td  class="F"><div name="password" id="password"></div></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td  class="F" width=20% valign='top' bgcolor='#efefef'>曾用密码：:</td>
		<td  class="F"><div name="old_password" id="old_password"></div></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	...
	<tr bgcolor="#FFFFFF">
		<td  class="F" width=20% valign='top' bgcolor='#efefef'>偏好科室:</td>
		<td  class="F"><div name="preference" id="preference"></div></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	...
	<tr bgcolor="#FFFFFF">
		<td  class="F" width=20% valign='top' bgcolor='#efefef'>简介：:</td>
		<td  class="F"><div name="brief" id="brief"></div></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td  class="F" width=20% valign='top' bgcolor='#efefef'>擅长领域：:</td>
		<td  class="F"><div name="skilled_fields" id="skilled_fields"></div></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	...
	<tr bgcolor="#FFFFFF">
		<td  class="F" width=20% valign='top' bgcolor='#efefef'>毕业院校：:</td>
		<td  class="F"><div name="college" id="college"></div></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td  class="F" width=20% valign='top' bgcolor='#efefef'>所属学会：:</td>
		<td  class="F"><div name="society" id="society"></div></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td  class="F" width=20% valign='top' bgcolor='#efefef'>所在医院：:</td>
		<td  class="F"><div name="hospital" id="hospital"></div></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td  class="F" width=20% valign='top' bgcolor='#efefef'>科室：:</td>
		<td  class="F"><div name="department" id="department"></div></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td  class="F" width=20% valign='top' bgcolor='#efefef'>职称：:</td>
		<td  class="F"><div name="job_title" id="job_title"></div></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td  class="F" width=20% valign='top' bgcolor='#efefef'>所属学科：:</td>
		<td  class="F"><div name="section" id="section"></div></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td  class="F" width=20% valign='top' bgcolor='#efefef'>医学联络员：:</td>
		<td  class="F"><div name="liaisons" id="liaisons"></div></td>
	</tr>
	<tr bgcolor="#FFFFFF">
