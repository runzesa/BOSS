...
function sort(fieldName){
	selectDataLoad1();
	var fields=new Array("name","id_card_no","phone_no","account","password","old_password","role","sex","job_title","hospital","department","society","section","liaisons","point","credit","register_time","modify_time","email","birthday","college","is_identify","status","area");
	if(order==null){
		order="true";
...
function get_type(type){
	switch(type){
		...
		case 'credit_type':
			return 'string';
		case 'register_time_type':
			return 'string';
		case 'modify_time_type':
			return 'string';
		case 'email_type':
			return 'string';
		case 'birthday_type':
