...
function sort(fieldName){
	selectDataLoad1();
	var fields=new Array("name","id_card_no","phone_no","account","password","old_password","role","sex","point","credit","register_time","modify_time","email","birthday","is_identify","status","area");
	if(order==null){
		order="true";
