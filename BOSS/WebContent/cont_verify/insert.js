...
function newData(){
	var forms=new Array("account","name","email","phone_no","head_img","sex","idcard_img","id_card_no","birthday","role","register_time","is_identify","status","point","credit","cert_img","area");
	clearForm(forms);
...
function saveData(){
	if(!checkDataPro("cont_verifyform")){
		return;
	}
