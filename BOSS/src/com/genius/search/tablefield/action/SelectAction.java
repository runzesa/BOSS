...
public final class SelectAction implements Controller {
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		myList = tablefieldExt.select(pageNo, request.getParameter("order"), orderType, searchField, searchValue,null);
		PageDataConfig myData = new PageDataConfig(tablefieldExt.totalSize, 20, pageNo);
		...
		return new ModelAndView("tf_index.jsp");
	}
}
