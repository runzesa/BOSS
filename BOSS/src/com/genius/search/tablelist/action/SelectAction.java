...
public final class SelectAction implements Controller {
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		TablelistExt iTablelist = new TablelistExt();
		myList = iTablelist.select(pageNo, request.getParameter("order"), orderType, searchField, searchValue,null);
		
		PageDataConfig myData = new PageDataConfig(iTablelist.totalSize, 20, pageNo);
		...
		request.setAttribute("titleLinkList", myList);

		return new ModelAndView("tl_index.jsp");
	}
}
