...
import com.genius.search.tablelist.ITablelist;
...
public final class InsertSelectNewAction implements Controller {
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		ITablelist tablelist = (ITablelist) context
				.getBean("tablelistProxy");
		tablelist.setSId(session.getAttribute("userId").toString());
