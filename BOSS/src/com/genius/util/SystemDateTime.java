...
public class SystemDateTime {
	...
	public String getDateTime(){
		...
		String dateTime = this.datetime(today);
		return dateTime;
	}
	...
	public String datetime(Calendar cal) {
		int monCyl;
		int leapMonth = 0;
		Date baseDate = null;
		try {
		...
		return chineseDateFormat.format((new Date()).getTime()) + "   农历" +
			this.cyclical()+ this.animalsYear() + "年   " +(leap ? "闰" : "") + 
