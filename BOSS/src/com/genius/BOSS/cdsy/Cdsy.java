...
public class Cdsy implements ICdsy {
	...
	public ArrayList select(int pageNo, String orderField, String orderType, String searchField,String searchValue,String pager, String filter){
		...
		try {
			...
			while(rs.next()){
				SelectActionBean cdsyBean=new SelectActionBean();
				
				cdsyBean.setId(rs.getString("id"));
				
				cdsyBean.setTitle(rs.getString("title"));
				
				cdsyBean.setUser_id(rs.getString("user_id"));
				
				cdsyBean.setType(rs.getString("type"));
				
				cdsyBean.setDepartment(rs.getString("department"));
				
				cdsyBean.setOperate_state(rs.getString("operate_state"));
				
				cdsyBean.setOpen_state(rs.getString("open_state"));
				
				cdsyBean.setScore(rs.getString("score"));
				
				cdsyBean.setAcademic(rs.getString("academic"));
				
				cdsyBean.setApply_state(rs.getString("apply_state"));
				
				cdsyBean.setCreate_user(rs.getString("create_user"));
				
				cdsyBean.setCreate_time(rs.getString("create_time"));
				
				cdsyBean.setAudior_name(rs.getString("audior_name"));
				
				cdsyBean.setSource(rs.getString("source"));
				
				cdsyBean.setKey_word(rs.getString("key_word"));
				
				cdsyBean.setUcg(rs.getString("ucg"));
