...
content=TextFormat.getSqlText(content);
		...
		try {
			if (cdsy.insertEdit(source,apply_state,department,create_time,img_url,operate_state,user_id,ucg,open_state,modify_user,title,audior_name,modify_time,attachment_id,rank_type,info,academic,content,key_word,id,cover_img,score,create_user,type)) {
				success = "true";
			} else {
				success = "false";
			}
