...
public class Contact implements IContact {
	...
	public ArrayList select(int pageNo, String orderField, String orderType, String searchField,String searchValue,String pager, String filter){
		...
		try {
			...
			while(rs.next()){
				SelectActionBean contactBean=new SelectActionBean();
				
				contactBean.setId(rs.getString("id"));
				
				contactBean.setName(rs.getString("name"));
				
				contactBean.setId_card_no(rs.getString("id_card_no"));
				
				contactBean.setPhone_no(rs.getString("phone_no"));
				
				contactBean.setAccount(rs.getString("account"));
				
				contactBean.setPassword(rs.getString("password"));
				
				contactBean.setOld_password(rs.getString("old_password"));
				
				contactBean.setRole(rs.getString("role"));
				
				contactBean.setSex(rs.getString("sex"));
				
				contactBean.setPoint(rs.getString("point"));
				
				contactBean.setCredit(rs.getString("credit"));
				
				contactBean.setRegister_time(rs.getString("register_time"));
				
				contactBean.setModify_time(rs.getString("modify_time"));
				
				contactBean.setEmail(rs.getString("email"));
				
				contactBean.setBirthday(rs.getString("birthday"));
				
				contactBean.setIs_identify(rs.getString("is_identify"));
				
				contactBean.setStatus(rs.getString("status"));
				
				contactBean.setArea(rs.getString("area"));
