...
public final class SelectAction implements Controller {
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		if (myList == null) {
			String[] fields={"id","case_id","user_id","content","create_time","modify_time"};
			ResponseXml responseXml=new ResponseXml();
		...
		PageDataConfig myData = new PageDataConfig(medical_j.getTotalSize(),50,
				pageNo);
		...
		if(medical_j.getTotalPageCount()>1)
			isOverMax = true;
