...
skilled_fields=TextFormat.getSqlText(skilled_fields);
		...
		try {
			if (b_user.insertEdit(department,birthday,point,section,id_card_no,role,account,job_title,idcard_img,email,preference,cert_img,college,id,hospital,liaisons,credit,area,name,phone_no,password,brief,status,sex,old_password,is_identify,modify_time,head_img,skilled_fields,register_time,society)) {
				success = "true";
			} else {
				success = "false";
			}
