...
public final class SelectAction implements Controller {
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		if (myList == null) {
			String[] fields={"id","name","id_card_no","phone_no","account","password","old_password","role","sex","job_title","hospital","department","society","section","liaisons","point","credit","register_time","modify_time","email","birthday","college","is_identify","status","area"};
			ResponseXml responseXml=new ResponseXml();
		...
		PageDataConfig myData = new PageDataConfig(b_user.getTotalSize(),50,
				pageNo);
		...
		while (it.hasNext()) {
			...
			field9.setAttribute("name", "job_title");
			field9.setAttribute("value", bean.getJob_title()==null?"":bean.getJob_title());
			row.addContent(field9);
			
			Element field10 = new Element("field");
			field10.setAttribute("name", "hospital");
			field10.setAttribute("value", bean.getHospital()==null?"":bean.getHospital());
			row.addContent(field10);
			
			Element field11 = new Element("field");
			field11.setAttribute("name", "department");
			field11.setAttribute("value", bean.getDepartment()==null?"":bean.getDepartment());
			row.addContent(field11);
			
			Element field12 = new Element("field");
			field12.setAttribute("name", "society");
			field12.setAttribute("value", bean.getSociety()==null?"":bean.getSociety());
			row.addContent(field12);
			
			Element field13 = new Element("field");
			field13.setAttribute("name", "section");
			field13.setAttribute("value", bean.getSection()==null?"":bean.getSection());
			row.addContent(field13);
			
			Element field14 = new Element("field");
			field14.setAttribute("name", "liaisons");
			field14.setAttribute("value", bean.getLiaisons()==null?"":bean.getLiaisons());
			row.addContent(field14);
			
			Element field15 = new Element("field");
			field15.setAttribute("name", "point");
			field15.setAttribute("value", bean.getPoint()==null?"":bean.getPoint());
			row.addContent(field15);
			
			Element field16 = new Element("field");
			field16.setAttribute("name", "credit");
			field16.setAttribute("value", bean.getCredit()==null?"":bean.getCredit());
			row.addContent(field16);
			
			Element field17 = new Element("field");
			field17.setAttribute("name", "register_time");
			field17.setAttribute("value", bean.getRegister_time()==null?"":bean.getRegister_time());
			row.addContent(field17);
			
			Element field18 = new Element("field");
			field18.setAttribute("name", "modify_time");
			field18.setAttribute("value", bean.getModify_time()==null?"":bean.getModify_time());
			row.addContent(field18);
			
			Element field19 = new Element("field");
			field19.setAttribute("name", "email");
			field19.setAttribute("value", bean.getEmail()==null?"":bean.getEmail());
			row.addContent(field19);
			
			Element field20 = new Element("field");
			field20.setAttribute("name", "birthday");
			field20.setAttribute("value", bean.getBirthday()==null?"":bean.getBirthday());
			row.addContent(field20);
			
			Element field21 = new Element("field");
			field21.setAttribute("name", "college");
			field21.setAttribute("value", bean.getCollege()==null?"":bean.getCollege());
			row.addContent(field21);
			
			Element field22 = new Element("field");
			field22.setAttribute("name", "is_identify");
			field22.setAttribute("value", bean.getIs_identify()==null?"":bean.getIs_identify());
			row.addContent(field22);
			
			Element field23 = new Element("field");
			field23.setAttribute("name", "status");
			field23.setAttribute("value", bean.getStatus()==null?"":bean.getStatus());
			row.addContent(field23);
			
			Element field24 = new Element("field");
			field24.setAttribute("name", "area");
			field24.setAttribute("value", bean.getArea()==null?"":bean.getArea());
