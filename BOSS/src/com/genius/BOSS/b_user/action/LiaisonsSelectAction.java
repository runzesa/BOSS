...
public final class LiaisonsSelectAction implements Controller {
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		ArrayList liaisonsList=new ArrayList();
		liaisonsList=b_user.liaisonsInsertSelect(pid); 
		
		Element root = new Element("entity");
		Iterator it = liaisonsList.iterator();

		while (it.hasNext()) {
			LiaisonsActionBean bean = (LiaisonsActionBean) it.next();
