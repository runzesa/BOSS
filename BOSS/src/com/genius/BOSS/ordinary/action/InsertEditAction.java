...
public final class InsertEditAction implements Controller {
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		try {
			if (ordinary.insertEdit(credit,birthday,area,point,name,phone_no,password,id_card_no,status,role,account,idcard_img,sex,email,modify_time,is_identify,old_password,cert_img,head_img,register_time,id)) {
				success = "true";
			} else {
				success = "false";
			}
