...
import com.genius.BOSS.PCbar.PCbarExt;
...
public class SelectExcelAction implements Controller {
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		myList = PCbar.select(pageNo, request.getParameter("order"), orderType, searchField, searchValue, pager,null);
		if (myList == null) {
			return new ModelAndView("/error.jsp");
		}

		HSSFWorkbook workbook = PCbar.selectExcelSelect();
