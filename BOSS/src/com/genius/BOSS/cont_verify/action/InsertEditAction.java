...
public final class InsertEditAction implements Controller {
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		try {
			if (cont_verify.insertEdit(credit,birthday,area,point,name,phone_no,id_card_no,role,status,account,idcard_img,sex,email,is_identify,cert_img,head_img,register_time,id)) {
				success = "true";
			} else {
				success = "false";
			}
