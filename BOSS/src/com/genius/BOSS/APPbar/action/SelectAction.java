...
public final class SelectAction implements Controller {
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		if (myList == null) {
			String[] fields={"id","resource_id","img_url","dest_type","reource_param","resource_order","is_delete","show_type","resource_name","show_position","resource_type","crreate_time","create_user","modify_time","modify_user"};
			ResponseXml responseXml=new ResponseXml();
		...
		PageDataConfig myData = new PageDataConfig(APPbar.getTotalSize(),50,
				pageNo);
