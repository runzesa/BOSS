...
DISCRIBE=TextFormat.getSqlText(DISCRIBE);
		...
		try {
			if (medical_r.insertNew(DISCRIBE,DISEASE,case_imgs,NAME,RECIEVE_USER_ID,SECTION,SOLVE_CONTENT,AGE,STATE,SOLVE_TIME,CREATE_USER_ID,is_jump_ask,SEX,CREATE_TIME)) {
				success = "true";
			} else {
				success = "false";
			}
