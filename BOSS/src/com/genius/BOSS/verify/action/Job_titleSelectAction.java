...
public final class Job_titleSelectAction implements Controller {
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		ArrayList job_titleList=new ArrayList();
		job_titleList=verify.job_titleInsertSelect(); 
		
		Element root = new Element("entity");
		Iterator it = job_titleList.iterator();

		while (it.hasNext()) {
			Job_titleActionBean bean = (Job_titleActionBean) it.next();
