...
brief=TextFormat.getSqlText(brief);
		...
		try {
			if (verify.insertEdit(department,birthday,point,section,id_card_no,role,account,idcard_img,job_title,cert_img,college,id,hospital,liaisons,credit,area,name,phone_no,brief,status,sex,modify_time,is_identify,head_img,register_time,society)) {
				success = "true";
			} else {
				success = "false";
			}
