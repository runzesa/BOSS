...
public final class SelectAction implements Controller {
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		if (myList == null) {
			String[] fields={"id","name","id_card_no","phone_no","account","role","sex","job_title","hospital","department","society","section","liaisons","point","credit","register_time","email","birthday","college","is_identify","area"};
			ResponseXml responseXml=new ResponseXml();
		...
		PageDataConfig myData = new PageDataConfig(verify.getTotalSize(),50,
				pageNo);
		...
		while (it.hasNext()) {
			...
			field7.setAttribute("name", "job_title");
			field7.setAttribute("value", bean.getJob_title()==null?"":bean.getJob_title());
			row.addContent(field7);
			
			Element field8 = new Element("field");
			field8.setAttribute("name", "hospital");
			field8.setAttribute("value", bean.getHospital()==null?"":bean.getHospital());
			row.addContent(field8);
			
			Element field9 = new Element("field");
			field9.setAttribute("name", "department");
			field9.setAttribute("value", bean.getDepartment()==null?"":bean.getDepartment());
			row.addContent(field9);
			
			Element field10 = new Element("field");
			field10.setAttribute("name", "society");
			field10.setAttribute("value", bean.getSociety()==null?"":bean.getSociety());
			row.addContent(field10);
			
			Element field11 = new Element("field");
			field11.setAttribute("name", "section");
			field11.setAttribute("value", bean.getSection()==null?"":bean.getSection());
			row.addContent(field11);
			
			Element field12 = new Element("field");
			field12.setAttribute("name", "liaisons");
			field12.setAttribute("value", bean.getLiaisons()==null?"":bean.getLiaisons());
			row.addContent(field12);
			
			Element field13 = new Element("field");
			field13.setAttribute("name", "point");
			field13.setAttribute("value", bean.getPoint()==null?"":bean.getPoint());
			row.addContent(field13);
			
			Element field14 = new Element("field");
			field14.setAttribute("name", "credit");
			field14.setAttribute("value", bean.getCredit()==null?"":bean.getCredit());
			row.addContent(field14);
			
			Element field15 = new Element("field");
			field15.setAttribute("name", "register_time");
			field15.setAttribute("value", bean.getRegister_time()==null?"":bean.getRegister_time());
			row.addContent(field15);
			
			Element field16 = new Element("field");
			field16.setAttribute("name", "email");
			field16.setAttribute("value", bean.getEmail()==null?"":bean.getEmail());
			row.addContent(field16);
			
			Element field17 = new Element("field");
			field17.setAttribute("name", "birthday");
			field17.setAttribute("value", bean.getBirthday()==null?"":bean.getBirthday());
			...
			field19.setAttribute("name", "is_identify");
			field19.setAttribute("value", bean.getIs_identify()==null?"":bean.getIs_identify());
